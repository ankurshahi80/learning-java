...
public class Test {
    ...
    public void demo() {
        ...
        // Notice that we are even using the List interface and mocking that interface
        ...
        // They are real objects that rely on actual codes

        List myList2 = spy(ArrayList.class);
        ...
        // This is useful when checking the service layer to ensure that your service method
